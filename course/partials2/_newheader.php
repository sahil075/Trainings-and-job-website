    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      ...
      <div class="collapse navbar-collapse" id="navmenu">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item">
                                <a href="#learn" class="nav-link" style="color: black">How Youll Learn</a>
                            </li>
                            <li class="nav-item">
                                <a href="#syllabus" class="nav-link" style="color: black">Syllabus</a>
                            </li>
                            <li class="nav-item">
                                <a href="#instructors" class="nav-link" style="color: black">Instructors</a>
                            </li>
                        </ul>
       </div>
